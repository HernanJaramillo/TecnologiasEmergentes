...
class DetalleProducto extends React.Component {
                    ...
                    <div className="panel-body">
                        <div className="container-info">
                            <div className="imagen-producto">
                                <img src={Utilidades.server + "src/img/" + this.state.producto.imagen} alt={this.state.producto.nombre} />
                            </div>
                            <div className="info-producto">
                                <ul>
                                    <li><label>Precio:&nbsp;</label>${this.state.producto.precio}</li>
                                    <li><label>Unidades Disponibles:&nbsp;</label>{this.state.producto.stock}</li>
                                </ul>
                            </div>
                        </div>
    ...
    /*---Consultamos  los productos existentes-----*/
    getProducto() {
        request
