...
class IniciarSesion extends React.Component {
                ...
                <div className="form-login">
                    ...
                    <form id="form-login">
                        <div className="campo-formulario">
                            ...
                            <input type="email" id="correo-input" name="correo-input" required pattern="[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?"/>
    ...
    // Valida el usuario del formulario con la funcion checkValidity de HTML
    validarUsuario() {
        ...
        if (inputContrasena.checkValidity() && inputCorreo.checkValidity()) {
            ...
            request
            /*----- Obtenemos los usuarios dados de alta en la base de datos firebase ----*/  
                .get('https://tiendaonline-6a97f.firebaseio.com/usuarios.json')
